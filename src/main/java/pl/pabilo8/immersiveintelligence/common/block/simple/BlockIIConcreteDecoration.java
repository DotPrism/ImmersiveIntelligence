...
public class BlockIIConcreteDecoration extends BlockIIBase<ConcreteDecorations>
{
	...
	{
		@IIBlockProperties(hardness = 2, blastResistance = 360, harvestLevel = 1, oreDict = "bricksConcrete", category = IICategory.RESOURCE)
		CONCRETE_BRICKS,
		@IIBlockProperties(hardness = 6, blastResistance = 1600, harvestLevel = 2, oreDict = "sturdyBricksConcrete", category = IICategory.RESOURCE)
		STURDY_CONCRETE_BRICKS,
		@IIBlockProperties(hardness = 10, blastResistance = 2400, harvestLevel = 3, oreDict = "uberConcrete", category = IICategory.RESOURCE)
		UBERCONCRETE
	}
