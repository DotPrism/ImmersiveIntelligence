...
import pl.pabilo8.immersiveintelligence.common.event.EvenIIItemCreated;
...
public class ItemIIBase extends Item implements IColouredItem
{
	...
	public IIItemProperties getItemProperties() { return IIUtils.getAnnotation(IIItemProperties.class,this); }

	@Override
	public void onCreated(ItemStack stack, World worldIn, EntityPlayer playerIn)
	{
		super.onCreated(stack, worldIn, playerIn);
		EvenIIItemCreated.fireItemCreatedEvent(playerIn, stack);
	}
