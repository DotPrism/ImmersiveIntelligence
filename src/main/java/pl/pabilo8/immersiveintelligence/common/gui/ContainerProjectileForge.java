 ...
 * @since 10-07-2019
 */
public class ContainerProjectileForge extends ContainerIEBase<TileEntityProjectileForge>
{
	public ContainerProjectileForge(EntityPlayer player, TileEntityProjectileForge tile)
	{
