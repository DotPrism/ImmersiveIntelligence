...
import pl.pabilo8.immersiveintelligence.common.gui.ContainerProjectileForge;
 ...
 * @since 10-07-2019
 */
public class GuiProjectileForge extends GuiAmmunitionBase<TileEntityProjectileForge>
{
	...
	public GuiProjectileForge(EntityPlayer player, TileEntityProjectileForge tile)
	{
		super(player, tile, ContainerProjectileForge::new);
	...
	protected void drawGuiContainerBackgroundLayer(float f, int mx, int my)
	{
		...
		if(tile.fillerUpgrade)
		{
			...
			{
				int max = (int)(ProjectileForge.fillingTime+ProjectileForge.fillingTime*0.3*tile.producedBullet.getCaliber());
		...
		else
		{
			...
			if(!tile.effect.isEmpty())
			{
				int max = (int)(ProjectileForge.fillingTime+ProjectileForge.productionTime*0.3*tile.producedBullet.getCaliber());
